                ...
                with ThreadPoolExecutor() as executor:
                    ...
                    for idx, future in enumerate(as_completed(futures), start=1):
                        ...
                        if "Error" in str(status_code):
                            print(
                                f"{Fore.MAGENTA}{index_str}{Fore.GREEN} Found: {Fore.WHITE}{url} {Fore.BLUE} - Status code: {status_code}")
                        else:
                            print(
                                f"{Fore.MAGENTA}{index_str}{Fore.GREEN} Found: {Fore.WHITE}{url} {Fore.BLUE} - Status code: {status_code}")
                        print(
                            f"{Fore.MAGENTA} → {Fore.CYAN}URL: {Fore.WHITE}https://web.archive.org/web/*/{encoded_url}")
                        print()
                        found_urls += 1
...
def Banner():
    print(rf"{Fore.RED}  |___ \| || |  _ ____|  |  / /||__   __ _ _ __ ___| |__   __ \ \   ")
    print(rf"{Fore.RED}   __) | || |_| | | | '__| | | |'_ \ / _` | '__/ __| '_ \ / _` | |  ")
    print(rf"{Fore.RED}    / __/|__   _| |_| | |  | | || | | | (_| | |  \__ \ | | | (_| |  ")
    print(rf"{Fore.RED}   |_____|  |_|  \__,_|_|  |_| ||_| |_|\__,_|_|  |___/_| |_|\__,_|  ")
    print(rf"{Fore.RED}                            \_\                               /_/   ")
    ...
    created_by_text = "Program created by: Harsha Vardhan raju"
    ascii_width = 49
